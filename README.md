...
> [!WARNING]
>
> **This repository is archived** and kept for historical reference only. **For new projects, use [Chainlink Runtime Environment (CRE)](https://docs.chain.link/cre)** for offchain logic, data fetching, and scheduled or event-driven automation instead of Chainlink Functions and Chainlink Automation.
